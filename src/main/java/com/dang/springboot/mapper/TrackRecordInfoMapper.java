...
import com.dang.springboot.pojo.TrackRecordInfo;
import com.dang.springboot.pojo.TrackRecordInfoExample;
import java.util.List;
import org.apache.ibatis.annotations.Param;

public interface TrackRecordInfoMapper {
    long countByExample(TrackRecordInfoExample example);
